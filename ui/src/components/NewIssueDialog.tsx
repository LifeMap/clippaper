      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-2.5 border-b border-border shrink-0">
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <span>{t("components.newIssueDialog.title")}</span>
          </div>
        ...
        <div className="px-4 pt-4 pb-2 shrink-0">
          <textarea
            ...
            placeholder={t("components.newIssueDialog.issueTitle")}
            rows={1}
            value={title}
            onChange={(e) => {
        ...
        <div className="px-4 pb-2 shrink-0">
          <div className="overflow-x-auto overscroll-x-contain">
            <div className="inline-flex items-center gap-2 text-sm text-muted-foreground flex-wrap sm:flex-nowrap sm:min-w-max">
              <span>{t("components.newIssueDialog.for")}</span>
              ...
              />
              <span>{t("components.newIssueDialog.in")}</span>
              <InlineEntitySelector
        ...
        {currentProject && currentProjectSupportsExecutionWorkspace && (
          <div className="px-4 py-3 shrink-0 space-y-2">
            <div className="space-y-1.5">
              <div className="text-xs font-medium">{t("components.newIssueDialog.executionWorkspace")}</div>
              <div className="text-[11px] text-muted-foreground">
                {t("components.newIssueDialog.executionWorkspaceDesc")}
              </div>
              <select
              ...
              {executionWorkspaceMode === "reuse_existing" && (
                ...
                >
                  <option value="">{t("components.newIssueDialog.chooseExistingWorkspace")}</option>
        ...
        >
          ...
          >
            <MarkdownEditor
              ...
              placeholder={t("components.newIssueDialog.addDescription")}
              bordered={false}
            ...
            <div className="mt-4 space-y-3 rounded-lg border border-border/70 p-3">
              {stagedDocuments.length > 0 ? (
                <div className="space-y-2">
                  <div className="text-xs font-medium text-muted-foreground">{t("components.newIssueDialog.documents")}</div>
                  <div className="space-y-2">
              ...
              {stagedAttachments.length > 0 ? (
                <div className="space-y-2">
                  <div className="text-xs font-medium text-muted-foreground">{t("components.newIssueDialog.attachments")}</div>
                  <div className="space-y-2">
        ...
        <div className="flex items-center gap-1.5 px-4 py-2 border-t border-border flex-wrap shrink-0">
              ...
              <button className="inline-flex items-center gap-1.5 rounded-md border border-border px-2 py-1 text-xs hover:bg-accent/50 transition-colors">
                {currentPriority ? (
                  ...
                  <>
                    ...
                    {t("components.newIssueDialog.priority")}
                  </>
                )}
              </button>
            </PopoverTrigger>
          ...
          <button className="inline-flex items-center gap-1.5 rounded-md border border-border px-2 py-1 text-xs hover:bg-accent/50 transition-colors text-muted-foreground">
            ...
            {t("components.newIssueDialog.labels")}
          </button>
          ...
          >
            ...
            {t("components.newIssueDialog.upload")}
          </button>
          ...
          <Popover open={moreOpen} onOpenChange={setMoreOpen}>
            ...
            <PopoverContent className="w-44 p-1" align="start">
              <button className="flex items-center gap-2 w-full px-2 py-1.5 text-xs rounded hover:bg-accent/50 text-muted-foreground">
                ...
                {t("components.newIssueDialog.startDate")}
              </button>
              <button className="flex items-center gap-2 w-full px-2 py-1.5 text-xs rounded hover:bg-accent/50 text-muted-foreground">
                <Calendar className="h-3 w-3" />
                {t("components.newIssueDialog.dueDate")}
              </button>
            </PopoverContent>
          </Popover>
        </div>
        ...
        <div className="flex items-center justify-between px-4 py-2.5 border-t border-border shrink-0">
          ...
          >
            {t("components.newIssueDialog.discardDraft")}
          </Button>
          <div className="flex items-center gap-3">
            <div className="min-h-5 text-right">
              {createIssue.isPending ? (
                <span className="inline-flex items-center gap-1.5 text-xs font-medium text-muted-foreground">
                  ...
                  {t("components.newIssueDialog.creatingIssue")}
                </span>
              ) : createIssue.isError ? (
            ...
            >
              <span className="inline-flex items-center justify-center gap-1.5">
                ...
                <span>{createIssue.isPending ? t("components.newIssueDialog.creating") : t("components.newIssueDialog.createIssue")}</span>
              </span>
            </Button>
          </div>
        </div>
