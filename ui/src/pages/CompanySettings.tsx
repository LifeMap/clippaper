        ...
        <div className="space-y-3 rounded-md border border-border px-4 py-4">
          <div className="flex items-center gap-1.5">
            <span className="text-xs text-muted-foreground">
              {t("companySettings.generateInviteHint")}
            </span>
            <HintIcon text={t("companySettings.generateInviteTooltip")} />
          </div>
          <div className="flex flex-wrap items-center gap-2">
            ...
            >
              {inviteMutation.isPending
                ...
                : t("companySettings.generateInviteButton")}
            </Button>
          </div>
          {inviteError && (
      ...
      <div className="space-y-4">
        ...
        <div className="rounded-md border border-border px-4 py-4">
          <p className="text-sm text-muted-foreground">
            {t("companySettings.companyPackagesHint")}{" "}
            <a href="/org" className="underline hover:text-foreground">{t("companySettings.orgChart")}</a>.
          </p>
