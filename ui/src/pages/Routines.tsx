  ...
  const updateRoutineStatus = useMutation({
    ...
    onError: (mutationError) => {
      pushToast({
        ...
        body: mutationError instanceof Error ? mutationError.message : t("routines.failedToUpdateRoutineBody"),
        tone: "error",
      });
    },
  });
  ...
  const runRoutine = useMutation({
    ...
    onError: (mutationError) => {
      pushToast({
        ...
        body: mutationError instanceof Error ? mutationError.message : t("routines.routineRunFailedBody"),
        tone: "error",
      });
    },
  });
              ...
              <Collapsible open={advancedOpen} onOpenChange={setAdvancedOpen}>
                <CollapsibleTrigger className="flex w-full items-center justify-between text-left">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">{t("routines.advancedDeliverySettingsHint")}</p>
                  </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-3 py-2.5 text-muted-foreground">
                        <div>{routine.lastRun?.triggeredAt ? new Date(routine.lastRun.triggeredAt).toLocaleString() : t("routines.never")}</div>
                        {routine.lastRun ? (
                      ...
                      <td className="px-3 py-2.5" onClick={(e) => e.stopPropagation()}>
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-xs text-muted-foreground">
                            {isArchived ? t("routines.archived") : enabled ? t("routines.on") : t("routines.off")}
                          </span>
                        </div>
                      </td>
